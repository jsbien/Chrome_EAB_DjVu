...
\title{Dokumenty DjVu w Internecie.\\Reaktywacja\\Google Chrome}

\author{Janusz S. Bień}


\date{\today\\\doclicenseLongName\\\url{https://github.com/jsbien/Chrome_EAB_DjVu}}
...
\begin{quote}
\textbf{  Niniejszy tekst jest uakualnieniem notatki
  \autocite{bien_dokumenty_2020} uwzględniajacym tylko nowe aspekty
  przeglądarki \textsf{Google Chrom}.}
\end{quote}

W swoim czasie format DjVu był powszechnie używany m.in. w polskich
...
Rozwiązanie problemu pojawiło się dość dawno, ale nie zostało
